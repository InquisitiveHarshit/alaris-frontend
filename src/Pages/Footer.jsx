    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold">Gaur Alaris</h2>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+9195766 71333" className="text-gray-400 hover:text-amber-400">
                   +91 95766 71333
                  </a>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold mb-2">Collection Account Details</h4>
                <p className="text-gray-400 text-sm">
                  Name: GAURSONS INDIA PVT LTD COLLECTION A/C- GAUR ALARIS (PHASE 1)
                  <br />
                  Project Collection Account No.: 57500001944130
                  <br />
                  Bank Name: HDFC BANK LIMITED
                  <br />
                  IFSC Code: HDFC0002649
                  <br />
                  Bank Address: C/25, STELLAR IT PARK, SECTOR - 62, GREATER NOIDA, UTTAR PRADESH, 201306
                  <br />
                  Launch Date: 28-07-26
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Gaur Alaris (Phase 1). All rights reserved.
