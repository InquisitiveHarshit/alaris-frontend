  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/95 backdrop-blur-xl shadow-lg text-black"
          : "bg-white/70 backdrop-blur-md border-b border-white/30 text-gray-900"
      }`}
    >
      <div className="mx-auto px-3 py-3">
        <div className="flex items-center justify-between">
          ...
          <motion.div whileHover={{ scale: 1.05 }}>
            <img
              src={optimizeCloudinary("https://res.cloudinary.com/dzvwqhzgf/image/upload/v1764587281/Gaurs_dsqmnw.png")}
              alt="Gaurs Logo"
