      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our stunning collection of images showcasing luxury living at Gaur Alaris
          </p>
        </motion.div>
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gray-100 aspect-square">
                <img
                  src={optimizeCloudinary(item.thumbnail)}
                  alt={item.title}
            ...
            >
              ...
              >
                {selectedImage.type === 'video' ? (
                  ...
                  <img
                    src={optimizeCloudinary(selectedImage.image)}
